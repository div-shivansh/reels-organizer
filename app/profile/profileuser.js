              ...
              <div className='flex flex-col xs:p-5 gap-2'>
                ...
                <div className="flex max-sm:flex-col items-center sm:px-3 w-full">
                  ...
                  <div className="flex flex-col w-full gap-1 truncate">
                    ...
                    <Link href={`https://instagram.com/${userData?.handle}`} target='_blank' className='xs:text-xl truncate text-lg hover:bg-neutral-700 hover:rounded p-1 hover:text-green-400 transition-all duration-150 ease-in'>@{userData?.handle}</Link>
                  </div>
                </div>
